        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {architectures.map((arch, index) => (
            <button
              ...
              className="group relative bg-card rounded-2xl overflow-hidden border border-border hover:border-accent/30 transition-all duration-300 hover:shadow-lg text-left"
            >
              {/* Placeholder Image */}
